...
public static class WaitHandleExtensions
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WaitHandleAwaitable ConfigureAwait(this WaitHandle waitHandle, CancellationToken cancellationToken) => new(waitHandle, timeoutMs: -1, cancellationToken: cancellationToken);
    ...
    /// <returns>Returns an object that produces a configured awaiter for the <see cref="System.Threading.WaitHandle"/></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WaitHandleAwaitable ConfigureAwait(this WaitHandle waitHandle, int timeoutMs, CancellationToken cancellationToken = default) => new(waitHandle, timeoutMs, cancellationToken);
    ...
    /// <returns>Returns an object that produces a configured awaiter for the <see cref="System.Threading.WaitHandle"/></returns>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static WaitHandleAwaitable ConfigureAwait(this WaitHandle waitHandle, TimeSpan timeout, CancellationToken cancellationToken = default) => new(waitHandle, (int)timeout.TotalMilliseconds, cancellationToken);
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Task WaitOneAsync(this WaitHandle waitHandle, CancellationToken cancellationToken = default) => waitHandle.WaitOneAsync(timeoutMs: -1, cancellationToken: cancellationToken);
    ...
    /// <exception cref="System.OperationCanceledException">Throws <see cref="System.OperationCanceledException"/> if the cancellation was requested using given <paramref name="cancellationToken"/></exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Task<bool> WaitOneAsync(this WaitHandle waitHandle, TimeSpan timeout, CancellationToken cancellationToken = default) => waitHandle.WaitOneAsync((int)timeout.TotalMilliseconds, cancellationToken);
    ...
    /// <returns>Returns a task which result tells if the <see cref="System.Threading.WaitHandle"/> signaled (True) or didn't (False), or throws the <see cref="System.OperationCanceledException"/></returns>
    /// <exception cref="System.OperationCanceledException">Throws <see cref="System.OperationCanceledException"/> if the cancellation was requested using given <paramref name="cancellationToken"/></exception>
    public static Task<bool> WaitOneAsync(this WaitHandle waitHandle, int timeoutMs, CancellationToken cancellationToken = default) => WaitHandleAsyncOperations.WaitOneAsync(waitHandle, timeoutMs, cancellationToken);
    ...
    /// <exception cref="System.OperationCanceledException">Throws <see cref="System.OperationCanceledException"/> if the cancellation was requested using given <paramref name="cancellationToken"/></exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Task<int> WaitAnyAsync(this IEnumerable<WaitHandle> waitHandles, CancellationToken cancellationToken = default) => waitHandles.WaitAnyAsync(timeoutMs: -1, cancellationToken: cancellationToken);
    ...
    /// <exception cref="System.OperationCanceledException">Throws <see cref="System.OperationCanceledException"/> if the cancellation was requested using given <paramref name="cancellationToken"/></exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Task<int> WaitAnyAsync(this IEnumerable<WaitHandle> waitHandles, TimeSpan timeout, CancellationToken cancellationToken = default) => waitHandles.WaitAnyAsync((int)timeout.TotalMilliseconds, cancellationToken);
    ...
    /// <exception cref="System.OperationCanceledException">Throws <see cref="System.OperationCanceledException"/> if the cancellation was requested using given <paramref name="cancellationToken"/></exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Task<int> WaitAnyAsync(this IEnumerable<WaitHandle> waitHandles, int timeoutMs, CancellationToken cancellationToken = default) => WaitHandleAsyncOperations.WaitAnyAsync(waitHandles, timeoutMs, cancellationToken);
    ...
    /// <exception cref="System.OperationCanceledException">Throws <see cref="System.OperationCanceledException"/> if the cancellation was requested using given <paramref name="cancellationToken"/></exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Task WaitAllAsync(this IEnumerable<WaitHandle> waitHandles, CancellationToken cancellationToken = default) => waitHandles.WaitAllAsync(timeoutMs: -1, cancellationToken: cancellationToken);
    ...
    /// <exception cref="System.OperationCanceledException">Throws <see cref="System.OperationCanceledException"/> if the cancellation was requested using given <paramref name="cancellationToken"/></exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Task<bool> WaitAllAsync(this IEnumerable<WaitHandle> waitHandles, TimeSpan timeout, CancellationToken cancellationToken = default) => waitHandles.WaitAllAsync((int)timeout.TotalMilliseconds, cancellationToken);
    ...
    /// <exception cref="System.OperationCanceledException">Throws <see cref="System.OperationCanceledException"/> if the cancellation was requested using given <paramref name="cancellationToken"/></exception>
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Task<bool> WaitAllAsync(this IEnumerable<WaitHandle> waitHandles, int timeoutMs, CancellationToken cancellationToken = default) => WaitHandleAsyncOperations.WaitAllAsync(waitHandles, timeoutMs, cancellationToken);
}
